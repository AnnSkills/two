...
import com.bsuir.annakhomyakova.web.rest.errors.*;
...
public class AccountResource {
    ...
    public void registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        UserAnnKh user = userService.registerUser(managedUserVM, managedUserVM.getPassword());
    ...
    public void activateAccount(@RequestParam(value = "key") String key) {
        Optional<UserAnnKh> user = userService.activateRegistration(key);
        if (!user.isPresent()) {
    ...
    public void saveAccount(@Valid @RequestBody AdminUserDTO userDTO) {
        ...
        Optional<UserAnnKh> existingUser = userRepository.findOneByEmailIgnoreCase(userDTO.getEmail());
        if (existingUser.isPresent() && (!existingUser.get().getLogin().equalsIgnoreCase(userLogin))) {
            throw new EmailAlreadyUsedException();
        }
        Optional<UserAnnKh> user = userRepository.findOneByLogin(userLogin);
        if (!user.isPresent()) {
    ...
    public void requestPasswordReset(@RequestBody String mail) {
        Optional<UserAnnKh> user = userService.requestPasswordReset(mail);
        if (user.isPresent()) {
    ...
    public void finishPasswordReset(@RequestBody KeyAndPasswordVM keyAndPassword) {
        ...
        Optional<UserAnnKh> user = userService.completePasswordReset(keyAndPassword.getNewPassword(), keyAndPassword.getKey());
