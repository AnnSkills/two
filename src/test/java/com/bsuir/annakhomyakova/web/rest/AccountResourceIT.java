...
import static com.bsuir.annakhomyakova.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import com.bsuir.annakhomyakova.config.Constants;
import com.bsuir.annakhomyakova.domain.PersistentToken;
import com.bsuir.annakhomyakova.domain.UserAnnKh;
import com.bsuir.annakhomyakova.repository.AuthorityRepository;
import com.bsuir.annakhomyakova.repository.PersistentTokenRepository;
import com.bsuir.annakhomyakova.repository.UserRepository;
...
import com.bsuir.annakhomyakova.service.dto.PasswordChangeDTO;
import com.bsuir.annakhomyakova.service.dto.UserDTO;
import com.bsuir.annakhomyakova.web.rest.vm.KeyAndPasswordVM;
import com.bsuir.annakhomyakova.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        Optional<UserAnnKh> user = userRepository.findOneByEmailIgnoreCase("funky@example.com");
    ...
    void testRegisterInvalidEmail() throws Exception {
        ...
        Optional<UserAnnKh> user = userRepository.findOneByLogin("bob");
        assertThat(user).isEmpty();
    }
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        Optional<UserAnnKh> testUser = userRepository.findOneByEmailIgnoreCase("alice2@example.com");
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        Optional<UserAnnKh> testUser1 = userRepository.findOneByLogin("test-register-duplicate-email");
        ...
        Optional<UserAnnKh> testUser2 = userRepository.findOneByLogin("test-register-duplicate-email");
        assertThat(testUser2).isEmpty();

        Optional<UserAnnKh> testUser3 = userRepository.findOneByLogin("test-register-duplicate-email-2");
        ...
        Optional<UserAnnKh> testUser4 = userRepository.findOneByLogin("test-register-duplicate-email-3");
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        Optional<UserAnnKh> userDup = userRepository.findOneWithAuthoritiesByLogin("badguy");
    ...
    void testSaveAccount() throws Exception {
        ...
        UserAnnKh updatedUser = userRepository.findOneWithAuthoritiesByLogin(user.getLogin()).orElse(null);
    ...
    void testSaveExistingEmail() throws Exception {
        ...
        UserAnnKh anotherUser = new UserAnnKh();
        ...
        UserAnnKh updatedUser = userRepository.findOneByLogin("save-existing-email").orElse(null);
    ...
    void testSaveExistingEmailAndLogin() throws Exception {
        ...
        UserAnnKh updatedUser = userRepository.findOneByLogin("save-existing-email-and-login").orElse(null);
    ...
    void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        UserAnnKh updatedUser = userRepository.findOneByLogin("change-password-wrong-existing-password").orElse(null);
    ...
    void testChangePassword() throws Exception {
        ...
        UserAnnKh updatedUser = userRepository.findOneByLogin("change-password").orElse(null);
    ...
    void testChangePasswordTooSmall() throws Exception {
        ...
        UserAnnKh updatedUser = userRepository.findOneByLogin("change-password-too-small").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testChangePasswordTooLong() throws Exception {
        ...
        UserAnnKh updatedUser = userRepository.findOneByLogin("change-password-too-long").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testChangePasswordEmpty() throws Exception {
        ...
        UserAnnKh updatedUser = userRepository.findOneByLogin("change-password-empty").orElse(null);
        assertThat(updatedUser.getPassword()).isEqualTo(user.getPassword());
    }
    ...
    void testFinishPasswordReset() throws Exception {
        ...
        UserAnnKh updatedUser = userRepository.findOneByLogin(user.getLogin()).orElse(null);
