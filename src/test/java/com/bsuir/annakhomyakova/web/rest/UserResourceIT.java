...
import com.bsuir.annakhomyakova.service.mapper.UserMapper;
...
class UserResourceIT {
     ...
     */
    public static UserAnnKh initTestUser(UserRepository userRepository, EntityManager em) {
        UserAnnKh user = createEntity(em);
    ...
    void createUser() throws Exception {
        ...
        assertPersistedUsers(users -> {
            ...
            UserAnnKh testUser = users.get(users.size() - 1);
    ...
    void updateUser() throws Exception {
        ...
        // Update the user
        UserAnnKh updatedUser = userRepository.findById(user.getId()).get();
        ...
        assertPersistedUsers(users -> {
            ...
            UserAnnKh testUser = users.stream().filter(usr -> usr.getId().equals(updatedUser.getId())).findFirst().get();
    ...
    void testUserEquals() throws Exception {
        TestUtil.equalsVerifier(UserAnnKh.class);
        UserAnnKh user1 = new UserAnnKh();
        user1.setId(DEFAULT_ID);
        UserAnnKh user2 = new UserAnnKh();
    ...
    void testUserDTOtoUser() {
        ...
        UserAnnKh user = userMapper.userDTOToUser(userDTO);
    ...
    private void assertPersistedUsers(Consumer<List<UserAnnKh>> userAssertion) {
