package com.bsuir.annakhomyakova.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.bsuir.annakhomyakova.IntegrationTest;
import com.bsuir.annakhomyakova.repository.timezone.DateTimeWrapper;
import com.bsuir.annakhomyakova.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM anna_date_time_wrapper where id=%d", fieldName, id);
    }
